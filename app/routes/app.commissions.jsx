    ...
    commissions.map(
      ...
      (commission) => ({
        ...
        tradeAccount:
          ...
          commission.tradeAccount

            ? {

                id:

                  commission.tradeAccount.id,
...
export const action = async ({
  ...
  if (
    ...
    if (
      ...
      return {
        ...
        error:
          ...
          `Commission cannot be approved because its current status is ${commission.status}.`,
     ...
     * Zero commission cannot be approved.
    ...
    if (
      ...
      return {
        ...
        error:
          ...
          "A commission of £0.00 cannot be approved.",
    ...
    console.log({
      ...
      tradeAccountId:
        ...
        updated.tradeAccountId,



      shopifyOrderId:

        updated.shopifyOrderId,
  ...
  if (
    ...
    if (
      ...
      return {
        ...
        error:
          ...
          `Commission cannot be paid because its current status is ${commission.status}.`,
     ...
     * Zero commission cannot be paid.
    ...
    if (
      ...
      return {
        ...
        error:
          ...
          "A commission of £0.00 cannot be paid.",
     ...
     * It records that the administrator has paid

     * the designer externally.

     *

     * Later this can be connected to a payment provider.
      ...
      <div className="page-header">
        ...
        <div>
          ...
          <p>
            ...
            Manage designer commissions,

            approvals, refunds and payments.
